...
public class Dragon implements Comparable<Dragon> {
    ...
    * @see DragonCave
    */
    public Dragon(int id, String name, Coordinates coordinates, LocalDateTime creationDate, long age, String description, double wingspan, Color color, DragonCave cave) {
        this.id = id;
        this.name = name;
     ...
     * @see DragonCave
     */
    public Dragon(int id, String name, Coordinates coordinates, long age, String description, double wingspan, Color color, DragonCave cave) {
        this.id = id;
        this.name = name;
        this.coordinates = coordinates;
     ...
     * @see DragonCave
     */
    public Dragon(String name, Coordinates coordinates, long age, String description, double wingspan, Color color, DragonCave cave) {
    ...
    /**
    * Конвертирует объект класса в XML строку
    * @return XML String
    */
    public String toXml() {
        return "\n\t\t<dragon id=\"" + id + "\" "
                + "name=\"" + name + "\" x=\"" + coordinates.getX() + "\" "
                + "y=\"" + coordinates.getY() + "\" creationDate=\"" + creationDate + "\" "
                + "age=\"" + age + "\" description=\"" + description + "\" "
                + "wingspan=\"" + wingspan + "\" color=\"" + color + "\" cave=\"" + cave.getNumberOfTreasures() + "\" " +
                "/>";
    }
    ...
    /**
     * Метод для валидации аргументов, с которыми будет создан объект
